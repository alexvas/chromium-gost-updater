...
Можно пользоваться на свой страх и риск. Апач 2.0. Подробнее и зануднее в NOTICE.txt
...
Скрипт установки автоматически проверит наличие GUI-библиотек и библиотеки toml в системе:
...
## 3. Автоматическая установка обновлятора (рекомендуется)

Используйте скрипт `install.sh` для автоматической установки:
...
Если предпочитаете установку вручную, произведите операции из install.sh, скорректовав установочную директорию, файл иконки или конфиг.
