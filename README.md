...
Идея в том, что скрипт-обновлятор меняется редко, а браузер — часто. Установите скрипт один раз, и тот будет следить за обновлениями браузера Chromium Gost [на сайте с релизами](https://update.cryptopro.ru/chromium-gost/).
...
Забираете релиз на Github и оттуда его устанавливаете.
